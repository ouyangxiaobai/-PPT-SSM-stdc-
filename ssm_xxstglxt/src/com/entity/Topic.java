...
public class Topic {
	...
	public String toString() {
		return "Topic [topicid=" + this.topicid + ", usersid=" + this.usersid + ", ordersid=" + this.ordersid
				+ ", sellerid=" + this.sellerid + ", goodsid=" + this.goodsid + ", num=" + this.num + ", contents="
				+ this.contents + ", addtime=" + this.addtime + ", username=" + this.username + ", ordercode="
				+ this.ordercode + ", shopname=" + this.shopname + ", goodsname=" + this.goodsname + "]";
	}
