...
public class IndexController extends BaseController {
	...
	public String shop(String id, String number) {
		this.front();
	...
	public String preComplains() {
		...
		orders.setUsersid(userid);
		List<Orders> tempList = this.ordersService.getOrdersByCond(orders);
		this.getRequest().setAttribute("ordersList", tempList);
	...
	public String addComplains(Complains complains) {
		...
		Orders orders = this.ordersService.getOrdersById(complains.getOrdersid());
		complains.setGoodsid(orders.getGoodsid());
		complains.setSellerid(orders.getSellerid());
	...
	public String addTopic(String id) {
		...
		topic.setSellerid(orders.getSellerid());
