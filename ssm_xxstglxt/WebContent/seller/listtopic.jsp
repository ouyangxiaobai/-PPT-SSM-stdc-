...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>评价管理 <span class="c-gray en">&gt;</span> 评价列表 <a
		...
		<table class="table table-border table-bordered table-bg">
			...
			<c:forEach items="${topicList}" var="topic">
				<tr class="text-c">
					...
					<td>${topic.shopname}</td>
					<td>${topic.goodsname}</td>
					<td><img src="themes/ecmoban_dangdang/images/stars${topic.num }.gif" /></td>
