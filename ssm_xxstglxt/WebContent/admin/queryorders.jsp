...
<body>
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="13">订单查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${ordersList}" var="orders">
				<tr class="text-c">
					...
					<td class="center">${orders.goodsname}</td>
					<td class="center">${orders.shopname}</td>
		...
		<div class="text-c">
			<form action="orders/queryOrdersByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="ordercode">按订单查询</option>
						...
						<option value="address">按送餐地址查询</option>
