...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>食品管理 <span class="c-gray en">&gt;</span> 食品查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="11">食品查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${goodsList}" var="goods">
				<tr class="text-c">
					<td class="center">${goods.shopname}</td>
					...
					<td class="center">${goods.status}</td>
				</tr>
			</c:forEach>
		</table>
		...
		<div class="text-c">
			<form action="goods/queryGoodsByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="sellerid">按店铺查询</option>
						<option value="goodsname">按名称查询</option>
						<option value="cateid">按类型查询</option>
