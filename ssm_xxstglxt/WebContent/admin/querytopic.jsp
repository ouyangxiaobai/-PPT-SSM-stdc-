...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>评价管理 <span class="c-gray en">&gt;</span> 评价查询 <a
		...
		<table class="table table-border table-bordered table-bg">
			...
			<c:forEach items="${topicList}" var="topic">
				<tr class="text-c">
					...
					<td class="center">${topic.shopname}</td>
					<td class="center">${topic.goodsname}</td>
					<td class="center"><img src="themes/ecmoban_dangdang/images/stars${topic.num }.gif" /></td>
		...
		<div class="text-c">
			<form action="topic/queryTopicByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						...
						<option value="sellerid">按商户查询</option>
						<option value="goodsid">按食品查询</option>
